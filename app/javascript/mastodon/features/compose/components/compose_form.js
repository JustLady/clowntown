...
const messages = defineMessages({
  placeholder: { id: 'compose_form.placeholder', defaultMessage: 'gently to honk' },
  spoiler_placeholder: { id: 'compose_form.spoiler_placeholder', defaultMessage: 'dont forget' },
  publish: { id: 'compose_form.publish', defaultMessage: 'Honk' },
